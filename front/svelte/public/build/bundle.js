...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div5 = element("div");
    			div4 = element("div");
    			div4.textContent = "BBQuestion";
    			t7 = space();
    			div8 = element("div");
    			div7 = element("div");
    			h1 = element("h1");
    			h1.textContent = "kintone 知ってる？";
    			t9 = space();
    			hr = element("hr");
    			t10 = space();
    			table = element("table");
    			...
    			button0.textContent = "①使ったことある";
    			t12 = space();
    			td1 = element("td");
    			button1 = element("button");
    			button1.textContent = "②何ができるか知ってる";
    			t14 = space();
    			tr1 = element("tr");
    			td2 = element("td");
    			button2 = element("button");
    			button2.textContent = "③聞いたことならある";
    			t16 = space();
    			td3 = element("td");
    			button3 = element("button");
    			button3.textContent = "④初耳";
    			attr_dev(div0, "class", "logo cursor svelte-10totuw");
    			add_location(div0, file, 20, 6, 480);
    			attr_dev(div1, "class", "top svelte-10totuw");
    			add_location(div1, file, 19, 4, 456);
    			attr_dev(i0, "class", "fas fa-bars cursor svelte-10totuw");
    			add_location(i0, file, 24, 8, 589);
    			attr_dev(i1, "class", "fas fa-home cursor svelte-10totuw");
    			add_location(i1, file, 25, 8, 632);
    			attr_dev(i2, "class", "fas fa-bell cursor svelte-10totuw");
    			add_location(i2, file, 26, 8, 675);
    			attr_dev(i3, "class", "fas fa-star cursor svelte-10totuw");
    			add_location(i3, file, 27, 8, 718);
    			attr_dev(div2, "class", "icon svelte-10totuw");
    			add_location(div2, file, 23, 6, 562);
    			attr_dev(div3, "class", "menu svelte-10totuw");
    			add_location(div3, file, 22, 4, 537);
    			attr_dev(div4, "class", "title svelte-10totuw");
    			add_location(div4, file, 31, 6, 807);
    			attr_dev(div5, "class", "image svelte-10totuw");
    			add_location(div5, file, 30, 4, 781);
    			attr_dev(div6, "class", "header-contents svelte-10totuw");
    			add_location(div6, file, 18, 2, 422);
    			attr_dev(h1, "class", "svelte-10totuw");
    			add_location(h1, file, 36, 6, 924);
    			add_location(hr, file, 37, 6, 953);
    			attr_dev(button0, "class", "cursor svelte-10totuw");
    			button0.value = "0";
    			add_location(button0, file, 40, 14, 1015);
    			add_location(td0, file, 40, 10, 1011);
    			attr_dev(button1, "class", "cursor svelte-10totuw");
    			button1.value = "1";
    			add_location(button1, file, 41, 14, 1105);
    			add_location(td1, file, 41, 10, 1101);
    			add_location(tr0, file, 39, 8, 996);
    			attr_dev(button2, "class", "cursor svelte-10totuw");
    			button2.value = "2";
    			add_location(button2, file, 44, 14, 1225);
    			add_location(td2, file, 44, 10, 1221);
    			attr_dev(button3, "class", "cursor svelte-10totuw");
    			button3.value = "3";
    			add_location(button3, file, 45, 14, 1317);
    			add_location(td3, file, 45, 10, 1313);
    			add_location(tr1, file, 43, 8, 1206);
    			attr_dev(table, "class", "buttons svelte-10totuw");
    			add_location(table, file, 38, 6, 964);
    			attr_dev(div7, "class", "widget svelte-10totuw");
    			add_location(div7, file, 35, 4, 897);
    			attr_dev(div8, "class", "main-contents svelte-10totuw");
    			add_location(div8, file, 34, 2, 865);
    			add_location(main, file, 17, 0, 413);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*postData*/ ctx[0], false, false, false),
    					listen_dev(button1, "click", /*postData*/ ctx[0], false, false, false),
    					listen_dev(button2, "click", /*postData*/ ctx[0], false, false, false),
    					listen_dev(button3, "click", /*postData*/ ctx[0], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	const postData = async function () {
    		try {
    			const resp = await axios$1.post(url, { value: this.value });
    			console.log(resp);
    			await sweetalert_min("送信完了！");
    		} catch(err) {
    			await sweetalert_min("エラー発生！！");
    			console.log(err);
    		}
    	};
    	...
    	$$self.$capture_state = () => ({ swal: sweetalert_min, axios: axios$1, url, postData });
    	return [postData];
    }
